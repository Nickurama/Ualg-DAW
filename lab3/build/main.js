...
const transformation = __importStar(require("./myTransformations"));
const ldd = __importStar(require("./myLoadDataDestination"));
function getUsers() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield ldd.loadDataDestinationOne("result.txt", arr);
        }
        catch (error) {
            console.log(error);
        }
